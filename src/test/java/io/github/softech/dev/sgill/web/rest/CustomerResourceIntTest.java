...
public class CustomerResourceIntTest {
    ...
    private static final String DEFAULT_PHONE = "(440.2861913";
    private static final String UPDATED_PHONE = "(5963836670";

    private static final String DEFAULT_STREETADDRESS = "AAAAAAAAAA";
    private static final String UPDATED_STREETADDRESS = "BBBBBBBBBB";

    private static final String DEFAULT_POSTALCODE = "C6U 6P7";
    private static final String UPDATED_POSTALCODE = "43569-4371";
