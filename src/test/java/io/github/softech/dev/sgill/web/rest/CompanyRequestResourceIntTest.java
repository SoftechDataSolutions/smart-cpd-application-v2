...
import static io.github.softech.dev.sgill.web.rest.TestUtil.sameInstant;
...
public class CompanyRequestResourceIntTest {
    ...
    public void createCompanyRequest() throws Exception {
        ...
        assertThat(testCompanyRequest.getCycledate()).isEqualTo(DEFAULT_CYCLEDATE);
    ...
    public void checkCycledateIsRequired() throws Exception {
        int databaseSizeBeforeTest = companyRequestRepository.findAll().size();
        // set the field null
        companyRequest.setCycledate(null);
    ...
    @Test
    @Transactional
    public void getAllCompanyRequestsByCycledateIsEqualToSomething() throws Exception {
        // Initialize the database
        companyRequestRepository.saveAndFlush(companyRequest);

        // Get all the companyRequestList where cycledate equals to DEFAULT_CYCLEDATE
        defaultCompanyRequestShouldBeFound("cycledate.equals=" + DEFAULT_CYCLEDATE);

        // Get all the companyRequestList where cycledate equals to UPDATED_CYCLEDATE
        defaultCompanyRequestShouldNotBeFound("cycledate.equals=" + UPDATED_CYCLEDATE);
    }

    @Test
    @Transactional
    public void getAllCompanyRequestsByCycledateIsInShouldWork() throws Exception {
        // Initialize the database
        companyRequestRepository.saveAndFlush(companyRequest);

        // Get all the companyRequestList where cycledate in DEFAULT_CYCLEDATE or UPDATED_CYCLEDATE
        defaultCompanyRequestShouldBeFound("cycledate.in=" + DEFAULT_CYCLEDATE + "," + UPDATED_CYCLEDATE);

        // Get all the companyRequestList where cycledate equals to UPDATED_CYCLEDATE
        defaultCompanyRequestShouldNotBeFound("cycledate.in=" + UPDATED_CYCLEDATE);
    }

    @Test
    @Transactional
    public void getAllCompanyRequestsByCycledateIsNullOrNotNull() throws Exception {
        // Initialize the database
        companyRequestRepository.saveAndFlush(companyRequest);

        // Get all the companyRequestList where cycledate is not null
        defaultCompanyRequestShouldBeFound("cycledate.specified=true");

        // Get all the companyRequestList where cycledate is null
        defaultCompanyRequestShouldNotBeFound("cycledate.specified=false");
    }

    @Test
    @Transactional
    public void getAllCompanyRequestsByCycledateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        companyRequestRepository.saveAndFlush(companyRequest);

        // Get all the companyRequestList where cycledate greater than or equals to DEFAULT_CYCLEDATE
        defaultCompanyRequestShouldBeFound("cycledate.greaterOrEqualThan=" + DEFAULT_CYCLEDATE);

        // Get all the companyRequestList where cycledate greater than or equals to UPDATED_CYCLEDATE
        defaultCompanyRequestShouldNotBeFound("cycledate.greaterOrEqualThan=" + UPDATED_CYCLEDATE);
    }

    @Test
    @Transactional
    public void getAllCompanyRequestsByCycledateIsLessThanSomething() throws Exception {
        // Initialize the database
        companyRequestRepository.saveAndFlush(companyRequest);

        // Get all the companyRequestList where cycledate less than or equals to DEFAULT_CYCLEDATE
        defaultCompanyRequestShouldNotBeFound("cycledate.lessThan=" + DEFAULT_CYCLEDATE);

        // Get all the companyRequestList where cycledate less than or equals to UPDATED_CYCLEDATE
        defaultCompanyRequestShouldBeFound("cycledate.lessThan=" + UPDATED_CYCLEDATE);
    }
    ...
    public void updateCompanyRequest() throws Exception {
        ...
        assertThat(testCompanyRequest.getCycledate()).isEqualTo(UPDATED_CYCLEDATE);
