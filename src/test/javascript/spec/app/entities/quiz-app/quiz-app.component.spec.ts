...
import { QuizAppComponent } from 'app/entities/quiz-app/quiz-app.component';
import { QuizAppService } from 'app/entities/quiz-app/quiz-app.service';
import { QuizApp } from 'app/shared/model/quiz-app.model';

describe('Component Tests', () => {
    describe('QuizApp Management Component', () => {
        let comp: QuizAppComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(QuizAppComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.quizApps[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
