    ...
    describe('Bookmarks Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/bookmarks';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Bookmarks', () => {
                service.create(new Bookmarks(null)).subscribe(received => {
            ...
            it('should update a Bookmarks', () => {
                service.update(new Bookmarks(123)).subscribe(received => {
