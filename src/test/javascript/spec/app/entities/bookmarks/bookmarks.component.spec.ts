...
import { BookmarksComponent } from 'app/entities/bookmarks/bookmarks.component';
...
describe('Component Tests', () => {
    describe('Bookmarks Management Component', () => {
        let comp: BookmarksComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BookmarksComponent, '')
                .compileComponents();
